...
class ECarouFredSel extends CWidget
{
	...
	public function publishAssets()
	{
		...
		if(is_dir($assets)){	
			Yii::app()->clientScript->registerCssFile($baseUrl . '/carousel.css');
		
			Yii::app()->clientScript->registerScriptFile($baseUrl . '/jquery.carouFredSel-5.6.4-packed.js', CClientScript::POS_END);
		} else {

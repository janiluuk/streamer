...
class EUpdateDialog extends CWidget
{
   ...
   */
  public $dialogOptions = array("width" => 600, "height" => 480);
  
  /**
   * @var array an array with options for extension.
   */
  public $options = array("defaultWidth" => 600, "width" => 600);
  ...
  public function run()
  {
   ...
   // Create jQuery UI dialog
    ...
    array_pop(explode(".", $script)) == "css" ? $cs->registerCssFile( $script) :  $cs->registerScriptFile( $script, CClientScript::POS_END );
  }
}
?>

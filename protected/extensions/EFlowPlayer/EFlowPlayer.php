...
class EFlowPlayer extends CWidget
{
    ...
    public function init()
    {
        ...
        if(!isset($this->swfUrl)) $this->swfUrl = "http://releases.flowplayer.org/swf/flowplayer-3.2.15.swf";
    }
    /** 
	...
	Yii::app()->clientScript->registerScript($this->htmlOptions['id'] . rand(1020,20200),"

var url='" . $flv ."'; var player = flowplayer('".$this->htmlOptions['id']."', {src:'http://releases.flowplayer.org/swf/flowplayer-3.2.15.swf', wmode: 'opaque'}, {
